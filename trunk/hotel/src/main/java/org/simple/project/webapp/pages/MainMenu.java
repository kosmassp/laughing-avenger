...
import org.simple.project.webapp.data.UserSession;
...
public class MainMenu extends BasePage {
    ...
    Object onActionFromCheckIn() {
    	
    	System.out.println("Kosmas TEST Check In");
//        user = userSession.getCurrentUser();
//
//        if (user == null) {
//            String username = getRequest().getRemoteUser();
...
//        userEdit.setFrom("MainMenu");
    ...
    Object onActionFromBooking() {
    	
    	System.out.println("Kosmas TEST Booking");
//        user = userSession.getCurrentUser();
//
//        if (user == null) {
//            String username = getRequest().getRemoteUser();
...
//        userEdit.setFrom("MainMenu");
    ...
    Object onActionFromCheckOut() {
    	...
    	System.out.println("Kosmas TEST Check Out");
//        user = userSession.getCurrentUser();
//
//        if (user == null) {
//            String username = getRequest().getRemoteUser();
